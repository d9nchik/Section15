...
public class ClockPaneAnimation extends Pane {
    private int hour;
    private int minute;
    private int second;
     ...
     */
    public ClockPaneAnimation(int hour, int minute, int second) {
        this.hour = hour;
        this.minute = minute;
        this.second = second;
    }
    ...
    private void paintClock() {
        ...
        clockRadius = (clockRadius > 100) ? clockRadius : 100;
